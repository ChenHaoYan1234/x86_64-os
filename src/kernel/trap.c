...
void do_divide_error(unsigned long rsp, unsigned long)
{
    ...
    color_printk(RED, BLACK, "do_divide_error(0), RSP: %#018lx, RIP: %#018lx\n", rsp, *p);
    while (1)
        ;
}
...
void do_debug(unsigned long rsp, unsigned long)
{
    unsigned long *p = NULL;
    p = (unsigned long *)(rsp + 0x98);
    color_printk(RED, BLACK, "do_debug(1), RSP: %#018lx, RIP: %#018lx\n", rsp, *p);
    while (1)
        ;
}
...
void do_nmi(unsigned long rsp, unsigned long)
{
    unsigned long *p = NULL;
    p = (unsigned long *)(rsp + 0x98);
    color_printk(RED, BLACK, "do_nmi(2), RSP: %#018lx, RIP: %#018lx\n", rsp, *p);
    while (1)
        ;
}
...
void do_int3(unsigned long rsp, unsigned long)
{
    unsigned long *p = NULL;
    p = (unsigned long *)(rsp + 0x98);
    color_printk(RED, BLACK, "do_int3(3), RSP: %#018lx, RIP: %#018lx\n", rsp, *p);
    while (1)
        ;
}
...
void do_overflow(unsigned long rsp, unsigned long)
{
    unsigned long *p = NULL;
    p = (unsigned long *)(rsp + 0x98);
    color_printk(RED, BLACK, "do_overflow(4), RSP: %#018lx, RIP: %#018lx\n", rsp, *p);
    while (1)
        ;
}
...
void do_bounds(unsigned long rsp, unsigned long)
{
    unsigned long *p = NULL;
    p = (unsigned long *)(rsp + 0x98);
    color_printk(RED, BLACK, "do_bounds(5), RSP: %#018lx, RIP: %#018lx\n", rsp, *p);
    while (1)
        ;
}
...
void do_undefined_opcode(unsigned long rsp, unsigned long)
{
    unsigned long *p = NULL;
    p = (unsigned long *)(rsp + 0x98);
    color_printk(RED, BLACK, "do_undefined_opcode(6), RSP: %#018lx, RIP: %#018lx\n", rsp, *p);
    while (1)
        ;
}
...
void do_dev_not_available(unsigned long rsp, unsigned long)
{
    unsigned long *p = NULL;
    p = (unsigned long *)(rsp + 0x98);
    color_printk(RED, BLACK, "do_dev_not_available(7), RSP: %#018lx, RIP: %#018lx\n", rsp, *p);
    while (1)
        ;
}
...
void do_coprocessor_segment_overrun(unsigned long rsp, unsigned long)
{
    unsigned long *p = NULL;
    p = (unsigned long *)(rsp + 0x98);
    color_printk(RED, BLACK, "do_coprocessor_segment_overrun(9), RSP: %#018lx, RIP: %#018lx\n", rsp, *p);
    while (1)
        ;
}
...
void do_invalid_tss(unsigned long rsp, unsigned long error_code)
{
    ...
    color_printk(RED, BLACK, "Segment Selector Index: %#018lx\n", error_code & 0xfff8);
...
void do_page_fault(unsigned long rsp, unsigned long error_code)
{
    ...
    if (error_code & 0x04)
        color_printk(RED, BLACK, "User Mode Fault(3)\t");
    else
        color_printk(RED, BLACK, "Kernel Mode Fault(0, 1, 2)\t");

    if (error_code & 0x08)
        color_printk(RED, BLACK, "Reserved Bit Set\t");

    if (error_code & 0x10)
        color_printk(RED, BLACK, "Instruction Fetch Fault\t");
...
void do_x87_fpu_error(unsigned long rsp, unsigned long)
{
    unsigned long *p = NULL;
    p = (unsigned long *)(rsp + 0x98);
    color_printk(RED, BLACK, "do_x87_fpu_error(16), RSP: %#018lx, RIP: %#018lx\n", rsp, *p);
    while (1)
        ;
}
...
void do_machine_check(unsigned long rsp, unsigned long)
{
    unsigned long *p = NULL;
    p = (unsigned long *)(rsp + 0x98);
    color_printk(RED, BLACK, "do_machine_check(18), RSP: %#018lx, RIP: %#018lx\n", rsp, *p);
    while (1)
        ;
}
...
void do_simd_fpu_exception(unsigned long rsp, unsigned long)
{
    unsigned long *p = NULL;
    p = (unsigned long *)(rsp + 0x98);
    color_printk(RED, BLACK, "do_simd_fpu_exception(19), RSP: %#018lx, RIP: %#018lx\n", rsp, *p);
    while (1)
        ;
}
...
void do_virtualization_exception(unsigned long rsp, unsigned long)
{
    unsigned long *p = NULL;
    p = (unsigned long *)(rsp + 0x98);
    color_printk(RED, BLACK, "do_virtualization_exception(20), RSP: %#018lx, RIP: %#018lx\n", rsp, *p);
    while (1)
        ;
}
...
void sys_vector_init()
{
    ...
    set_trap_gate(19, 1, simd_fpu_exception);
